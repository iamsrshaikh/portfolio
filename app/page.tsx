      ...
      <div className="flex-1 flex items-center justify-center p-8 mt-16 relative z-10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
              Hi, I'm <span className="text-blue-600">Sarfaraj Shaikh</span>
            </motion.h1>
            <motion.h2
            ...
            >
              Frontend Developer | ReactJS | Svelte
            </motion.h2>
            <motion.p
            ...
            >
              ...
              performance, and collaborate effectively in fast-paced
              environments.
            </motion.p>
            <motion.div
            ...
            >
              ...
              <a
                href="/resume.pdf"
                download="Sarfaraj_Shaikh_Resume.pdf"
