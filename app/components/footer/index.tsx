...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/iamsrshaikh",
      iconName: "github"
    },
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/sarfaraj-shaikh-4a8847193/",
      iconName: "linkedin"
    },
    {
      name: "Twitter",
      url: "https://x.com/shaikh_sh5532",
      iconName: "twitter"
    },
    {
      name: "Instagram",
      url: "https://www.instagram.com/iam_srshaikh/",
      iconName: "instagram"
    }
  ];
        ...
        <div className="flex flex-col-reverse md:flex-row justify-center md:justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="text-center md:text-left">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              © {currentYear} Sarfaraj Shaikh. All rights reserved.
            </p>
          </div>
